            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-4">
                        ...
                        <Link to="/profile" className="btn btn-danger"><i className="fa fa-search"></i> view your profile</Link>
                    </div>
                    <div className="col-lg-4 border-left">
                        ...
                        <Link to="/messages" className="btn btn-danger"><i className="fa fa-search"></i> view your messages</Link>
                    </div>
                    <div className="col-lg-4 border-left">
                        <h2>Form 41</h2>
                        ...
                        <Link to="/form" className="btn btn-danger"><i className="fa fa-search"></i> Purchase Form 41</Link>
                    </div>
