        ...
        <div className="container-fluid">
            ...
            <nav class="main-menu">
                <ul class="menu-list">
                    ...
                    <li><Link class="text text-primary" to="/zones">Zones</Link></li>
                    <li><Link class="text text-primary" to="/commands">Commands</Link></li>
                    <li><Link class="text text-primary" to="/users">Users</Link></li>
